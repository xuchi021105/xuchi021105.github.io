import{_ as e,W as p,X as o,Y as c,Z as n,$ as s,a0 as t,a2 as l,C as i}from"./framework-eefab691.js";const u="/assets/matrix-285f47d2.gif",r={},d=n("p",null,"matrix",-1),k=n("h2",{id:"起因",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#起因","aria-hidden":"true"},"#"),s(" 起因")],-1),m=n("p",null,[s("之前看到大佬朋友在学awk,并且用awk在终端中实现了黑客帝国中的代码雨(大佬tql,%%%),感觉效果挺好看的,并且是在终端中实现,正好最近也在考虑用go语言写点啥"),n("s",null,"本来考虑用gin来写一个web后端,但是没想好具体写啥,还是等web课大作业题目出来后再说吧"),s(",所以想到用go语言也来实现一个matrix"),n("s",null,"才不是为了水篇博客呢")],-1),v=n("p",null,[s("效果演示如下图,感觉效果还不错 "),n("img",{src:u,alt:"matrix",loading:"lazy"})],-1),b={href:"https://github.com/GeertJohan/gomatrix",target:"_blank",rel:"noopener noreferrer"},g={href:"https://github.com/xuchi021105/go-matrix",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"gomatrix",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#gomatrix","aria-hidden":"true"},"#"),s(" gomatrix")],-1),S=n("h3",{id:"用到的第三方库",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#用到的第三方库","aria-hidden":"true"},"#"),s(" 用到的第三方库")],-1),y={href:"https://github.com/gdamore/tcell",target:"_blank",rel:"noopener noreferrer"},f=n("li",null,[s("用go-flags库来控制命令行参数"),n("s",null,"文章中没提到")],-1),w={href:"https://github.com/davecgh/go-spew",target:"_blank",rel:"noopener noreferrer"},x=n("s",null,"文章中没提到",-1),C=l(`<h3 id="思路和代码实现" tabindex="-1"><a class="header-anchor" href="#思路和代码实现" aria-hidden="true">#</a> 思路和代码实现</h3><p>给出Stream结构体的定义</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Stream <span class="token keyword">struct</span> <span class="token punctuation">{</span>
...
EVENTS<span class="token punctuation">:</span>
	<span class="token keyword">for</span> <span class="token punctuation">{</span>
		...
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>写完这个matrix的实现花了3天多,主要是对go的语法其实不是很熟悉,而且之前对于channel和goroutine用的不多,总是理论多于实践,但是写完之后对于go的语法更加熟悉了, 并且知道了几个库的用法,还是挺有收获的<s>重点其实是水了篇博客</s>,这篇文章也就到这里结束啦,想要更多细节的话看源代码</p>`,47);function D(P,_){const a=i("ExternalLinkIcon");return p(),o("div",null,[d,c(" more "),k,m,v,n("p",null,[s("在网上找了找实现matrix的代码,在github上找到了"),n("a",b,[s("gomatrix"),t(a)]),s(",查看了源码之后,照着思路自己写了一下（"),n("a",g,[s("我的实现在这里"),t(a)]),s("),之后会介绍gomatrix实现的方法和我实现的方法")]),h,S,n("ul",null,[n("li",null,[s("使用了"),n("a",y,[s("tcell"),t(a)]),s("库来控制终端的输出(这个终端库可以监听终端上的键盘事件和鼠标事件等,类似gui库)")]),f,n("li",null,[n("a",w,[s("go-spew"),t(a)]),s("来进行输出调试(能够更具体的输出信息)"),x])]),C])}const W=e(r,[["render",D],["__file","go-matrix.html.vue"]]);export{W as default};
